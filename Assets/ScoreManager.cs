...
public class ScoreManager : MonoBehaviour
{
    ...
    public void Score()
    {
        switch(chooseLevel)
        {
            ...
            case 5:
                myTimer.text = "CURRENT: " + GameObject.FindWithTag("Player").GetComponent<Timer>().Min + ":" + GameObject.FindWithTag("Player").GetComponent<Timer>().Sec;
                myBestScore.text = "YOUR BEST: " + PlayerPrefs.GetFloat("BestScoreMin_Level5") + ":" + PlayerPrefs.GetFloat("BestScoreSec_Level5");

                if (GameObject.FindWithTag("Player").GetComponent<Timer>().Min < PlayerPrefs.GetFloat("BestScoreMin_Level5", 1000))
                {
                    myTimer.color = Color.green;
                    PlayerPrefs.SetFloat("BestScoreMin_Level5", GameObject.FindWithTag("Player").GetComponent<Timer>().Min);
                    PlayerPrefs.SetFloat("BestScoreSec_Level5", GameObject.FindWithTag("Player").GetComponent<Timer>().Sec);
                }

                else if (GameObject.FindWithTag("Player").GetComponent<Timer>().Min == PlayerPrefs.GetFloat("BestScoreMin_Level5", 1000))
                {
                    if (GameObject.FindWithTag("Player").GetComponent<Timer>().Sec < PlayerPrefs.GetFloat("BestScoreSec_Level5", 1000))
                    {
                        myTimer.color = Color.green;
                        PlayerPrefs.SetFloat("BestScoreMin_Level5", GameObject.FindWithTag("Player").GetComponent<Timer>().Min);
                        PlayerPrefs.SetFloat("BestScoreSec_Level5", GameObject.FindWithTag("Player").GetComponent<Timer>().Sec);
                    ...
                    else if (GameObject.FindWithTag("Player").GetComponent<Timer>().Sec > PlayerPrefs.GetFloat("BestScoreSec_Level5", 1000))
                    {
                        myTimer.color = Color.red;
                    }
                }
