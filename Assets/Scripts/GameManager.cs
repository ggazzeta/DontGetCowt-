...
public class GameManager : MonoBehaviour {
    ...
    private static string _youWon;
    private static string _congrats;
    private static string _next;

    public static string YouWon
    {
        get { return _youWon.youWonText(); }
        set { _youWon = value; }
    }
    public static string CongratsText
    {
        get { return _congrats.congratsText(); }
        set { _congrats = value; }
    }
    public static string NextText
    {
        get { return _next.nextText(); }
        set { _next = value; }
    }
}
